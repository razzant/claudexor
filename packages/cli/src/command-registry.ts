...
export const CLI_FLAGS: readonly CliFlagSpec[] = [
  { name: "harness", kind: "value", valueHint: "<id[,id...]>", help: "Force harness(es)" },
  {
    name: "mode",
    kind: "value",
    valueHint: "<mode>",
  ...
  { name: "tests", kind: "value", valueHint: '"<evidence>"', help: "Test evidence text for the review verb" },
  {
    ...
    kind: "value",
    valueHint: "<list>",
    help: 'Explicit reviewers, e.g. "claude=claude-opus-4-8:max,cursor=gemini-3.1-pro,cursor=gemini-3.5-flash,cursor=gpt-5.5-extra-high"',
  },
  {
    name: "reviewer-model",
    kind: "value",
  ...
  { name: "image", kind: "value", valueHint: "<path[,path...]>", help: "Attach image file(s) (alias for --attach with image kind)" },
  {
    ...
    kind: "value",
    valueHint: "<store>",
    help: "Secrets store: auto (default)|keychain|file (file = sandbox-safe, no Keychain)",
  },
  { name: "json", kind: "boolean", help: "Machine-readable JSON output" },
  { name: "all", kind: "boolean", help: null },
  {
    name: "dry-run",
    kind: "boolean",
  ...
  { name: "revoke-full-access", kind: "boolean", help: null },
  { name: "access-default", kind: "value", valueHint: "<profile>", help: null },
  // decision action/option flags (subcommand-scoped; documented in the decision usage line).
  { name: "accept-risk", kind: "boolean", help: null },
  { name: "override", kind: "boolean", help: null },
  { name: "revert", kind: "boolean", help: null },
  { name: "accept-clean-patch", kind: "boolean", help: null },
  { name: "rerun", kind: "boolean", help: null },
  { name: "apply-mode", kind: "value", valueHint: "<m>", help: null },
  { name: "feedback", kind: "value", valueHint: '"<text>"', help: null },
  { name: "help", kind: "boolean", help: "Show this help" },
  { name: "version", kind: "boolean", help: "Print the CLI version" },
];
...
export const CLI_COMMANDS: readonly CliCommandSpec[] = [
  ...
  },
  {
    ...
    flags: ["harness", "n", "web", "reviewer-panel", "reviewer-model", "reviewer-effort", "answers", "previous", "json"],
    mutability: "read",
    stability: "stable",
  },
  {
  ...
  },
  {
    id: "review",
    usageArgs: "--diff <file>",
    summary: "Reviewer-panel review of a diff file (per-commit gate)",
    flags: ["diff", "intent", "tests", "reviewer-panel", "json"],
    mutability: "read",
    stability: "stable",
  },
  {
