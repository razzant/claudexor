...
import { CLAUDEXOR_VERSION, userHomeDir, writeText } from "@claudexor/util";
  ...
  switch (host) {
    case "cursor": {
      ...
      writeText(
        ...
        JSON.stringify({ name: "claudexor", version: CLAUDEXOR_VERSION, description: "Claudexor control plane (thin shim)" }, null, 2) + "\n",
      );
