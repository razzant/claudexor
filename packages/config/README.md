...
Internal package of [Claudexor](https://github.com/joi-lab/claudexor) — Layered config loader (precedence + trust). Sensitive settings never from versioned repo config.
