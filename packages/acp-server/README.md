...
Internal package of [Claudexor](https://github.com/joi-lab/claudexor) — Minimal ACP server (stdio JSON-RPC) exposing Claudexor as a meta-agent to editors. Runner injected.
