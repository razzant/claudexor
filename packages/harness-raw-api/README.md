...
Internal package of [Claudexor](https://github.com/joi-lab/claudexor) — Raw-API harness: OpenAI-compatible chat completions (planner/reviewer; no native edit tools).
