...
Internal package of [Claudexor](https://github.com/razzant/claudexor) — WorkspaceEnvelope manager: git worktree + scoped HOME/harness-config isolation + dirty policy.
