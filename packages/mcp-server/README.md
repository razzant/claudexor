...
Internal package of [Claudexor](https://github.com/joi-lab/claudexor) — MCP server (official SDK, stdio) exposing Claudexor run/status tools with elicitation-backed interactive questions.
